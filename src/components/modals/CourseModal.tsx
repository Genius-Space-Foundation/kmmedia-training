        ...
        <>
          ...
          >
            ...
            <div className="relative h-64 md:h-80 shrink-0">
               ...
               <button
                 onClick={onClose}
                 className="absolute top-6 right-6 p-3 rounded-full bg-black/20 backdrop-blur-md text-white hover:bg-black/40 transition-colors z-20 border border-white/10"
               >
                 <X size={24} />
               </button>
            ...
            {/* Scrollable Content */}
            <div className="flex-1 overflow-y-auto p-8 md:p-12 scrollbar-thin scrollbar-thumb-neutral-200 dark:scrollbar-thumb-neutral-800">
               {/* Quick Stats Bar */}
            ...
            {/* Sticky Footnote / CTA */}
            <div className="shrink-0 bg-neutral-50 dark:bg-neutral-900 px-8 py-6 md:px-12 border-t border-neutral-100 dark:border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-6">
